                ...
                <div class="col-lg-3">
                    <div class="top-option">
                        ...
                        <div id="Home" class="tabcontent" style="display:none">
                            <h4 style="font-family: 'Roboto',arial,sans-serif;float: left;width: 80%;padding-top: 5%;padding-left: 5%;padding-bottom: 2%;border-bottom: 1px solid rgb(197, 197, 197)">
